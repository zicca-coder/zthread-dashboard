 ...
 * @LastEditors: fulei🐰
 * @LastEditTime: 2025-06-15 13:35:03
-->
  ...
  <div>
    <el-descriptions title="基础信息" :column="3" border>
      <el-descriptions-item label="环境标识" label-align="left">
        <el-tag :type="environmentMap[detailData.activeProfile] || 'primary'">
          {{ detailData.activeProfile }}
        </el-tag>
      </el-descriptions-item>
      <el-descriptions-item label="运行状态" label-align="left">
        <el-tag :type="statusMap[detailData.status] || 'primary'">
          {{ detailData.status }}
        </el-tag>
      </el-descriptions-item>
